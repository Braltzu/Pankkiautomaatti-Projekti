/****************************************************************************
** Meta object code from reading C++ file 'rfidcardreaderdll2.h'
**
...
#error "The header file 'rfidcardreaderdll2.h' doesn't include <QObject>."
...
constexpr auto qt_meta_stringdata_CLASSSerialPortReaderENDCLASS = QtMocHelpers::stringData(
    "SerialPortReader",
    "numberRead",
    "",
    "num",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSerialPortReaderENDCLASS_t qt_meta_stringdata_CLASSSerialPortReaderENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(17, 10),  // "numberRead"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 3),  // "num"
        QT_MOC_LITERAL(33, 10)   // "readNumber"
    },
    "SerialPortReader",
    "numberRead",
    "",
...
void SerialPortReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->numberRead((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->readNumber(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SerialPortReader::*)(QString );
            if (_t _q_method = &SerialPortReader::numberRead; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialPortReader::numberRead(QString _t1)
{
