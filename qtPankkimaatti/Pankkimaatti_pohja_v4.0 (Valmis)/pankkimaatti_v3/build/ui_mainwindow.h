...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        line_tunnus->setInputMethodHints(Qt::ImhHiddenText|Qt::ImhNoAutoUppercase|Qt::ImhNoPredictiveText|Qt::ImhSensitiveData);
        line_tunnus->setFrame(true);
        line_tunnus->setEchoMode(QLineEdit::Password);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        line_tunnus->setInputMask(QString());
        line_tunnus->setText(QString());
