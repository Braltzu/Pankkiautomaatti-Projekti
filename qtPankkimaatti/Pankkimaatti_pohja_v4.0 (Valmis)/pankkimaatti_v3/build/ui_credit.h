...
public:
    ...
    void setupUi(QWidget *Credit)
    {
        ...
        CR_button_takaisin->setGeometry(QRect(190, 190, 121, 61));
        CR_button_takaisin->setFont(font1);
        CRbutton_Nosto = new QPushButton(Credit);
        CRbutton_Nosto->setObjectName("CRbutton_Nosto");
        CRbutton_Nosto->setGeometry(QRect(50, 190, 121, 61));
        CRbutton_Nosto->setFont(font1);
    ...
    void retranslateUi(QWidget *Credit)
    {
        ...
        CRbutton_Nosto->setText(QCoreApplication::translate("Credit", "Nosto", nullptr));
    } // retranslateUi
