...
//vanhat connectit, PINUI ja RFID
//-----------------------------------------------------------------------------------------------------------
{
    ui->setupUi(this);
    //jämät vanhasta näyttönäppäimistöstä, jätetty tänne oman huvin ja esimerkin vuoksi
...
{   //menee siihen että näyttöön saa numeroita näppäimistön kautta
...
//numberclick tätä tarvitaan vain näyttönäppäimistössä ei muussa
//-----------------------------------------------------------------
...
void MainWindow::on_button_clear_clicked(){
    ...
    //tätäkään ei tarvitse kun ei ole näyttönäppistä
    //tämän piti vaihtaa näyttöjen välillä
...
//näitäkään ei tule tarvitsemaan ellei halua näyttönäppistä
//-----------------------------------------------------
